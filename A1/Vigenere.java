...
public final class Vigenere {
    ...
    public static void main(final String[] args) {
        String encrypted =
                "";
        int keyLength = 5;
        ...
        for (List<CharacterFrequency> frequencies : digitToFrequencies) {
            ...
            int keyInt = (mostFrequentChar - mostCommonCharOverall) % 26;
