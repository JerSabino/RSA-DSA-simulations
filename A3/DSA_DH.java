...
public class DSA_DH extends DSA {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //TAG B
            messageDigest.update(concatenate(new String[]{bobk1.toString(), Integer.toString(T), Integer.toString(bobID)}).toByteArray());
            ...
            //TAG A
            messageDigest.update(concatenate(new String[]{alicek1.toString(), Integer.toString(T), Integer.toString(aliceID)}).toByteArray());
            BigInteger tagA = new BigInteger(1, messageDigest.digest());
            System.out.println("\nTag A: " + tagA);

            //TAG VERIFY
            messageDigest.update(concatenate(new String[]{alicek1.toString(), Integer.toString(T), Integer.toString(bobID)}).toByteArray());
            ...
            //Step 4: Bob --------------------------------------------------------------------------------------------------
            //TAG VERIFY
            messageDigest.update(concatenate(new String[]{bobk1.toString(), Integer.toString(T), Integer.toString(aliceID)}).toByteArray());
            tagprime = new BigInteger(1, messageDigest.digest());  
