...
/**
 *  This code is a simulation of the DSA algorithm scheme. It utilizes Java's BigInteger class in order to achieve 
 *  simulation of a 128-bit security level. 
 * 
 *  For the sake of this simulation, we will use the following primes: 
...
public class DSA {
    ...
    // 2. Signing
    public static Signature signing(SigningKey sk, VerificationKey vk, String m, int print)
