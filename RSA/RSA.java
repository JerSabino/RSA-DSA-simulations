...
public class RSA {
    ...
    // Large primes
    // For this simulation, we will be using these large primes
    ...
    private static BigInteger q = new BigInteger(
            "");
     ...
     * 
     * @param msg The message to be converted to a BigInteger
     * @return The BigInteger representation of the message
     */
     ...
     * c = m^e mod n
     * 
     * @param msg       The message as BigInteger that is to be encrypted
     * @param publicKey The public key
     * @return The ciphertext as BigInteger
     */
     ...
     * 
     * @param cipher The ciphertext to be converted to a String message
     ...
     * @param vals   The values to be used in the CRT computation
     * @return The decrypted cipher
     */
     ...
     * @return The e such that e * d mod phi = 1
     */
    ...
    /**
     * Helper method to get the private key
     * 
